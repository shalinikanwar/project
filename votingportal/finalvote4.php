    ...
    <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../votingportal/login4.php">Vote here</a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" href="../votingportal/nomination4.html">File nomination</a>
          </li>
        </ul>
        <form class="d-flex">
...
<?php
    ...
    session_start();
    $userdata4 =$_SESSION['userdata4'];
    $groupsdata4 =$_SESSION['groupsdata4'];
   
    if($_SESSION['userdata4']['status4']==0){
        $status4 =' <b style="color:red">Not voted</b>';
    }
    else{
         $status4 =' <b style="color:green">voted</b>';
    }
...
<html>
    ...
    <body>
        ...
        <div id ="mainsection">
            ...
            <div id="mainpanel">
                <div id="Profile">
                <b>Status:</b> <?php echo $status4?> <br><br>
                </div>
                <div id="Group">
                    <?php
                        if($_SESSION['groupsdata4']){
                            for($i=0; $i<count($groupsdata4); $i++){
                                ?>
    
                                <div><br><br><br><br>
                                    <img src="../votingportal/uploads_candidate4/<?php echo $groupsdata4[$i]['photo'] ?>"height="200" width="200"> <br><br>
                                    <b>Candidate First Name: </b><?php echo $groupsdata4[$i]['Firstname'] ?> <br><br>
                                    <b>Candidate Last Name: </b><?php echo $groupsdata4[$i]['Lastname'] ?> <br><br>
                                    <b>Votes: </b><?php echo $groupsdata4[$i]['vote4'] ?><br><br>
                                    <form action="../votingportal/vote4.php" method ="POST">
                                        <input type="hidden" name="gvotes" value="<?php echo $groupsdata4[$i]['vote4'] ?>">
                                        <input type="hidden" name="gid" value="<?php echo $groupsdata4[$i]['id'] ?>">
                                        <?php
