    ...
    <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../votingportal/login2.php">Vote here</a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" href="../votingportal/nomination2.html">File nomination</a>
          </li>
        </ul>
        <form class="d-flex">
...
<?php
    ...
    session_start();
    $userdata2 =$_SESSION['userdata2'];
    $groupsdata2 =$_SESSION['groupsdata2'];
   
    if($_SESSION['userdata2']['status2']==0){
        $status2 =' <b style="color:red">Not voted</b>';
    }
    else{
         $status2 =' <b style="color:green">voted</b>';
    }
...
<html>
    ...
    <body>
        ...
        <div id ="mainsection">
            ...
            <div id="mainpanel">
                <div id="Profile">
                <b>Status:</b> <?php echo $status2?> <br><br>
                </div>
                <div id="Group">
                    <?php
                        if($_SESSION['groupsdata2']){
                            for($i=0; $i<count($groupsdata2); $i++){
                                ?>
    
                                <div><br><br><br><br>
                                    <img src="../votingportal/uploads_candidate2/<?php echo $groupsdata2[$i]['photo'] ?>"height="200" width="200"> <br><br>
                                    <b>Candidate First Name: </b><?php echo $groupsdata2[$i]['Firstname'] ?> <br><br>
                                    <b>Candidate Last Name: </b><?php echo $groupsdata2[$i]['Lastname'] ?> <br><br>
                                    <b>Votes: </b><?php echo $groupsdata2[$i]['vote2'] ?><br><br>
                                    <form action="../votingportal/vote2.php" method ="POST">
                                        <input type="hidden" name="gvotes" value="<?php echo $groupsdata2[$i]['vote2'] ?>">
                                        <input type="hidden" name="gid" value="<?php echo $groupsdata2[$i]['id'] ?>">
                                        <?php
