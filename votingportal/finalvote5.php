    ...
    <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../votingportal/login5.php">Vote here</a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" href="../votingportal/nomination5.html">File nomination</a>
          </li>
        </ul>
        <form class="d-flex">
...
<?php
    ...
    session_start();
    $userdata5 =$_SESSION['userdata5'];
    $groupsdata5 =$_SESSION['groupsdata5'];
   
    if($_SESSION['userdata5']['status5']==0){
        $status5 =' <b style="color:red">Not voted</b>';
    }
    else{
         $status5 =' <b style="color:green">voted</b>';
    }
...
<html>
    ...
    <body>
        ...
        <div id ="mainsection">
            ...
            <div id="mainpanel">
                <div id="Profile">
                <b>Status:</b> <?php echo $status5?> <br><br>
                </div>
                <div id="Group">
                    <?php
                        if($_SESSION['groupsdata5']){
                            for($i=0; $i<count($groupsdata5); $i++){
                                ?>
    
                                <div><br><br><br><br>
                                    <img src="../votingportal/uploads_candidate5/<?php echo $groupsdata5[$i]['photo'] ?>"height="200" width="200"> <br><br>
                                    <b>Candidate First Name: </b><?php echo $groupsdata5[$i]['Firstname'] ?> <br><br>
                                    <b>Candidate Last Name: </b><?php echo $groupsdata5[$i]['Lastname'] ?> <br><br>
                                    <b>Votes: </b><?php echo $groupsdata5[$i]['vote5'] ?><br><br>
                                    <form action="../votingportal/vote5.php" method ="POST">
                                        <input type="hidden" name="gvotes" value="<?php echo $groupsdata5[$i]['vote5'] ?>">
                                        <input type="hidden" name="gid" value="<?php echo $groupsdata5[$i]['id'] ?>">
                                        <?php
