    ...
    <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../votingportal/login6.php">Vote here</a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" href="../votingportal/nomination6.html">File nomination</a>
          </li>
        </ul>
        <form class="d-flex">
...
<?php
    ...
    session_start();
    $userdata6 =$_SESSION['userdata6'];
    $groupsdata6 =$_SESSION['groupsdata6'];
   
    if($_SESSION['userdata6']['status6']==0){
        $status6 =' <b style="color:red">Not voted</b>';
    }
    else{
         $status6 =' <b style="color:green">voted</b>';
    }
...
<html>
    ...
    <body>
        ...
        <div id ="mainsection">
            ...
            <div id="mainpanel">
                <div id="Profile">
                <b>Status:</b> <?php echo $status6?> <br><br>
                </div>
                <div id="Group">
                    <?php
                        if($_SESSION['groupsdata6']){
                            for($i=0; $i<count($groupsdata6); $i++){
                                ?>
    
                                <div><br><br><br><br>
                                    <img src="../votingportal/uploads_candidate6/<?php echo $groupsdata6[$i]['photo'] ?>"height="200" width="200"> <br><br>
                                    <b>Candidate First Name: </b><?php echo $groupsdata6[$i]['Firstname'] ?> <br><br>
                                    <b>Candidate Last Name: </b><?php echo $groupsdata6[$i]['Lastname'] ?> <br><br>
                                    <b>Votes: </b><?php echo $groupsdata6[$i]['vote6'] ?><br><br>
                                    <form action="../votingportal/vote6.php" method ="POST">
                                        <input type="hidden" name="gvotes" value="<?php echo $groupsdata6[$i]['vote6'] ?>">
                                        <input type="hidden" name="gid" value="<?php echo $groupsdata6[$i]['id'] ?>">
                                        <?php
