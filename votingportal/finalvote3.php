    ...
    <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../votingportal/login3.php">Vote here</a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" href="../votingportal/nomination3.html">File nomination</a>
          </li>
        </ul>
        <form class="d-flex">
...
<?php
    ...
    session_start();
    $userdata3 =$_SESSION['userdata3'];
    $groupsdata3 =$_SESSION['groupsdata3'];
   
    if($_SESSION['userdata3']['status3']==0){
        $status3 =' <b style="color:red">Not voted</b>';
    }
    else{
         $status3 =' <b style="color:green">voted</b>';
    }
...
<html>
    ...
    <body>
        ...
        <div id ="mainsection">
            ...
            <div id="mainpanel">
                <div id="Profile">
                <b>Status:</b> <?php echo $status3?> <br><br>
                </div>
                <div id="Group">
                    <?php
                        if($_SESSION['groupsdata3']){
                            for($i=0; $i<count($groupsdata3); $i++){
                                ?>
    
                                <div><br><br><br><br>
                                    <img src="../votingportal/uploads_candidate3/<?php echo $groupsdata3[$i]['photo'] ?>"height="200" width="200"> <br><br>
                                    <b>Candidate First Name: </b><?php echo $groupsdata3[$i]['Firstname'] ?> <br><br>
                                    <b>Candidate Last Name: </b><?php echo $groupsdata3[$i]['Lastname'] ?> <br><br>
                                    <b>Votes: </b><?php echo $groupsdata3[$i]['vote3'] ?><br><br>
                                    <form action="../votingportal/vote3.php" method ="POST">
                                        <input type="hidden" name="gvotes" value="<?php echo $groupsdata3[$i]['vote3'] ?>">
                                        <input type="hidden" name="gid" value="<?php echo $groupsdata3[$i]['id'] ?>">
                                        <?php
